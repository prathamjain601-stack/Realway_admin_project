...
// Error response logger — captures all 4xx/5xx into ErrorLog table
app.use(errorLogger);
...
app.use(async (err: any, req: express.Request, res: express.Response, next: express.NextFunction) => {
    ...
    // Flag so the errorLogger middleware doesn't double-log this error
    (req as any)._errorLogged = true;
